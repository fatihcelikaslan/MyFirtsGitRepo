...
public class skyWare {
	...
	public void firstTestCase() throws InterruptedException {
		driver.get("https://www.skyinventory.com");
		
//		Assert.assertTrue(driver.findElement(By.xpath("//*[@id=\"tabLink\"]")).isDisplayed());
		System.out.println(driver.getCurrentUrl());
//		String url = "https://www.skyinventory.com/";
//		Assert.assertEquals(url, driver.getCurrentUrl());
		
//		String title = "Free Web-based Inventory Tracking Software";
//		String titles = driver.getTitle();
//		Assert.assertEquals( driver.getTitle(), titles );
